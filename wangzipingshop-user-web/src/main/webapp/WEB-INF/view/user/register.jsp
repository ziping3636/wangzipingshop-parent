...
<body class="text-center">
	<form class="form-signin" method="post" action="/user/register">
		<img class="mb-4" src="./login_files/bootstrap-solid.svg" alt=""
			width="72" height="72">
		<h1 class="h3 mb-3 font-weight-normal">请输入您的注册信息</h1>
		<label for="name" class="sr-only">用户名</label> <input type="text"
			...
			<label for="name" class="sr-only">真实姓名</label> <input type="text"
			id="name" name="name" autocomplete="off" class="form-control" placeholder="真实姓名"
			required="" autofocus=""> 
			
			<label for="telephone" class="sr-only">电话</label> <input type="text"
			id="telephone" name="telephone" autocomplete="off" class="form-control" placeholder="电话"
			required="" autofocus=""> 
			
			<label for="email" class="sr-only">邮箱</label> <input type="text"
			id="email" name="email" autocomplete="off" class="form-control" placeholder="Email"
			required="" autofocus=""> 
